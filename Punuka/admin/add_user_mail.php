...
$mail->Subject = 'Punuka digital App Sign Up Details';
$mail->Body    = "You have successfully been registered to use the Punuka digital library app. 
	  \nBelow are your login details:\nE-mail: ".$email." \nPassword: ".$password.". 
	  \nWe strongly suggest you change your password at your first log-in.
	  \nYou can log on to the punuka library app when the app is hosted for general use for all staff members via www.punuka.com/libraryapp.
