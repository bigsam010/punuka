...
$resultset = $mysqli->query("SELECT * FROM files_suggest where purchased='' order by suggest_date asc");
...
?>
 <tr>
	...
	<td><?=$suggest_date?></td>
	<td><?=$suggest_link?></td>
	<td><button class="btn fsug" title="Purchased"><img src="images/p.png" class="mager"></button></td>
