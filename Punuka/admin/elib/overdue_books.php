        ...
        <div id="wrapper">
            ...
            <div id="main">
                <div class="inner">
                    ...
                    <!-- Header -->
                    <header id="header">
                        <center><h1>Overdue Borrowed Books
                            </h1>
                        </center>
                    </header>
...
if ($user_name == 'General-admin') {
    ...
    $resultset = $mysqli->query("SELECT * FROM borrowers where due_date <=('$currentdate') AND (location='$location' AND status='')");
}
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $location ?></td>
                                         <td><?= $slocation ?></td>
                                        <td><?= $due_date ?></td>
                                        <td><button class="btn sendit" title="Send mail" style="outline:none;"><img src="images/mail.png" class="mager"></button></td>
