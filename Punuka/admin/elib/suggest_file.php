...
$na = $mysqli->query("SELECT full_name, location FROM users WHERE staff_id='$staff_id'");
	if($na->num_rows == 1){
...
<div class="diff">
<p>Suggest a file that is of crucial need, but is currently not in the Punuka Library Collection</p>
...
setTimeout(function(){
	window.location.href='suggest_file.php';
},2000);
 </script>
 <?php 
  	}
