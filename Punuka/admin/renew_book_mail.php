...
$mail->Subject = 'Punuka Library Subscription Renewal';
$mail->Body    = "You have successfully renewed your subscription on ".$title.". The book will now be due for return on ".$date.". 
